...
function Cart() {
    ...
    return (
      <div className="max-w-7xl mx-auto py-16 px-4">
        <div className="text-center">
          <div className="bg-red-900 border border-red-400 text-red-100 px-4 py-3 rounded mb-6 inline-flex items-center mx-auto">
            <svg className="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
            </svg>
            <span className="font-medium">Order placed successfully!</span>
          </div>
          <h2 className="text-2xl font-bold mb-4 text-white">Thank you for your purchase</h2>
          <p className="text-gray-300 mb-2">Your transaction ID: <span className="font-semibold text-red-400">#{transactionId}</span></p>
          <p className="text-gray-300 mb-8">We've sent you a confirmation email with your order details.</p>
          <Link
            to="/"
    ...
    return (
      <div className="max-w-7xl mx-auto py-16 px-4">
        <div className="text-center">
          ...
          <p className="text-gray-300 mb-8">Looks like your cart needs unborking!</p>
          <Link
            to="/"
            className="bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-700 transition-colors"
          >
  ...
  return (
    <div className="max-w-7xl mx-auto py-16 px-4">
      ...
      {checkoutError && (
        <div className="bg-red-900 border border-red-400 text-red-100 px-4 py-3 rounded mb-6 flex items-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-gray-900 border border-red-500 rounded-lg shadow-md p-6 h-fit">
          ...
          <button
            ...
            className="w-full mt-6 bg-red-600 text-white py-3 rounded-lg flex items-center justify-center space-x-2 hover:bg-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
