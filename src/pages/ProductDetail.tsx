    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-gray-900 border border-red-500 rounded-lg shadow-lg overflow-hidden lg:flex">
        ...
        <div className="p-8 lg:w-1/2 text-white">
          ...
          {product.category && (
            <span className="inline-block bg-red-500 rounded-full px-3 py-1 text-sm font-semibold text-white mb-4">
              {product.category}
            </span>
          )}
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <button
              ...
              className="bg-red-500 text-white px-6 py-3 rounded-lg flex items-center space-x-2 hover:bg-red-700 transition-colors"
            >
