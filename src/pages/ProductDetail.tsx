...
const ProductDetail: React.FC = () => {
  ...
  if (error || !product) {
    return (
      <div className="text-center py-10">
        ...
        <Link to="/" className="inline-block mt-4 text-red-400 hover:underline">
          Back to Products
        </Link>
      </div>
    );
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <Link to="/" className="inline-flex items-center text-red-400 hover:underline mb-6">
        <ArrowLeft className="w-4 h-4 mr-2" />
        Back to Products
      </Link>
      <div className="bg-gray-900 border border-red-500 rounded-lg shadow-lg overflow-hidden lg:flex">
        ...
        <div className="p-8 lg:w-1/2">
          ...
          {product.category && (
            <span className="inline-block bg-red-700 rounded-full px-3 py-1 text-sm font-semibold text-white mb-4">
              {product.category}
            </span>
          )}
          ...
          <div className="border-t border-red-500 pt-6">
            <h3 className="text-lg font-semibold mb-3 text-white">Why You Need This</h3>
