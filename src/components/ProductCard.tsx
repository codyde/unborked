    ...
    >
      ...
      >
        ...
        <div className="p-4">
          ...
          <p className="text-red-400 mb-4 font-bold">${parseFloat(product.price).toFixed(2)}</p>
        </div>
      </Link>
      {user && (
        <div className="px-4 pb-4 flex justify-end">
          <button 
            ...
            className="inline-flex items-center space-x-2 bg-red-600 text-white py-2 px-4 rounded hover:bg-red-700 transition-colors duration-200"
          >
