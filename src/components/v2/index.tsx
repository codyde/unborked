...
const CyberpunkContainer: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <div className="w-full relative">
    ...
    <div className="fixed inset-0 w-full h-full overflow-hidden opacity-5 pointer-events-none">
      <div className="absolute inset-0 w-full h-full bg-[url('data:image/svg+xml;base64,')] bg-[length:50px_50px]"></div>
    </div>
    
    {/* Hexagon accents */}
    <div className="fixed bottom-20 right-10 w-40 h-40 border border-[#CC0000]/20 rotate-45 pointer-events-none"></div>
    <div className="fixed top-40 left-10 w-20 h-20 border border-[#FF0000]/20 rotate-45 pointer-events-none"></div>
...
const CyberpunkCard: React.FC<{
  ...
  >
    <div className="bg-[#000000] border border-[#FF0000] h-full pb-4">
      {/* Top corner accents */}
      <div className="absolute top-0 left-0 w-5 h-5 border-t border-l border-[#FF0000]"></div>
      <div className="absolute top-0 right-0 w-5 h-5 border-t border-r border-[#FF0000]"></div>
      
      {/* Bottom corner accents */}
      <div className="absolute bottom-0 left-0 w-5 h-5 border-b border-l border-[#FF0000]"></div>
      <div className="absolute bottom-0 right-0 w-5 h-5 border-b border-r border-[#FF0000]"></div>
      
      {/* Decorative elements */}
      <div className="absolute top-2 right-2 w-1.5 h-1.5 bg-[#CC0000]"></div>
      <div className="h-48 bg-gray-800 relative mb-3 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-full h-px bg-[#FF0000]"></div>
        <div className="absolute top-2 left-2 text-xs text-[#FF0000] font-mono">ID://0x{Math.floor(Math.random() * 10000).toString().padStart(4, '0')}</div>
      </div>
      
      <div className="px-4">
        <h3 className="text-[#FF0000] text-lg font-bold tracking-wide uppercase">{title}</h3>
        <div className="flex justify-between items-center mt-2">
          <div className="text-[#CC0000] font-mono font-bold">{price}</div>
    ...
    <div className="w-full relative">
      ...
      <div className="relative w-full bg-[#000000] overflow-hidden">
        ...
        <div className="relative h-[70vh] w-full">
          ...
          {/* Accent lines */}
          <div className="absolute bottom-0 left-0 w-full h-px bg-[#FF0000]"></div>
          <div className="absolute top-1/2 right-0 w-20 h-px bg-[#CC0000]"></div>
          ...
          <div className="absolute inset-0 flex items-center">
            <div className="container mx-auto px-6">
              <div className="max-w-2xl">
                ...
                <h2 className="text-3xl font-bold text-[#CC0000] mb-4 font-['Orbitron',sans-serif]">with Developer Swag</h2>
...
const CyberpunkFeaturedProducts: React.FC<{products: any[]}> = ({ products }) => (
  <div id="featured-products" className="container mx-auto px-6 py-16">
    <div className="mb-10 flex items-center">
      <div className="w-2 h-10 bg-[#CC0000] mr-4"></div>
  ...
  <CyberpunkContainer>
    <div className="container mx-auto px-6 py-10">
      <div className="mb-6 flex items-center">
        <div className="w-2 h-8 bg-[#CC0000] mr-4"></div>
